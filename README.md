...
| `enable`        | 1     | High to start a new read or write transaction                        |
| `addr`          | 25    | Byte address (25 bits → 32 MiB address space)                               |
...
### Usage Example
note:clk should be fin on any frequency lower than 100mhz after parameter INIT_DELAY AUTO_REF_DELAY set
```verilog
sdram u_sdram (
    .clk        (clk_100mhz),
    .rst        (rst),
